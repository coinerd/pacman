...
describe('MovementSystem', () => {
    ...
    describe('Movement', () => {
        ...
        test('should complete movement', () => {
            ...
            // Speed 100, tileSize 20 = 5 tiles/sec, need 0.2s + epsilon to complete
            system.update(0.21); // Complete
    ...
    describe('AI Integration', () => {
        ...
        test('AI should chase player', () => {
            ...
            const ghostState = system.getMovementState('ghost1');
            // Ghost at (5,1), player at (1,1) - should go LEFT
            expect(ghostState.direction).toBe(Direction.LEFT);
        });
